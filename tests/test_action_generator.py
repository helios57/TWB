...
class TestActionGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.game_state.building_levels = {'main': 1}
        self.game_state.resources = {'wood': 1000, 'stone': 1000, 'iron': 1000}
        self.action_generator.building_costs = {'main': {'wood': 100, 'stone': 100, 'iron': 100}}
    ...
    def test_generate_build_actions_handles_invalid_template_lines(self):
        ...
        self.action_generator.update_data(building_templates, {}, {}, {}, {})

        # The test passes if this doesn't raise a ValueError
        self.action_generator.generate(self.game_state)
